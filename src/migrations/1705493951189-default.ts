...
export class Default1705493951189 implements MigrationInterface {
    name = 'Default1705493951189'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "room" ADD "descriptiom" text NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "room" DROP COLUMN "descriptiom"`);
